...
```{r secret color chunk shhhh no one sees this degree, echo=F, warning=F, error=F}
...
```{r secret color chunk shhhh no one sees this betweenness, echo=F, warning=F, error=F}
...
```{r secret color chunk shhhh no one sees this closeness, echo=F, warning=F, error=F}
